...
class _CatHomeWidgetState extends State<CatHomeWidget> with WidgetsBindingObserver {
  ...
  //TODO: logic: khi bấm vào người, người sẽ ghi âm và chuyển về tiếng mèo kêu ở loa
  //TODO: logic: khi mèo bấm vào ghi âm thì sẽ chuyển thành text cho phù hợp
  //TODO: check xem có 1 từ mèo không
  ...
  void _onSpeechResult(SpeechRecognitionResult result, Action action) {
    print(result);
    if (result.recognizedWords.contains("meo") || result.recognizedWords.contains("mèo")) {
      // check render 1 lần
      // if (_lastWords != "") {
      //   return;
      // }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        // TODO: đây sẽ là chức năng loa
        IconButton(
          // onPressed: _speechToText.isNotListening ? _startListening : _stopListening,
          onPressed: () {
            //TODO: call just_audio
            changeAudio(cats[_random.nextInt(results.length)].audio);
          },
          tooltip: 'Translate',
          iconSize: 100,
